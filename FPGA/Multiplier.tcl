...
#
# Generated by Vivado on Fri Oct 14 15:47:39 +0800 2022
...
#
#    "C:/ChiselProject/BoothMultiplier/FPGA/Multiplier/Multiplier.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"
...
#    "C:/ChiselProject/BoothMultiplier/FPGA/Multiplier/Multiplier.srcs/sources_1/new/Multiplier_ref.v"
#    "c:/ChiselProject/BoothMultiplier/FPGA/Multiplier/Multiplier.srcs/sources_1/ip/xbip_multadd_0/xbip_multadd_0.xci"
...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [list \
   ...
   "./src/verilog/Multiplier39.v" \
   "./src/verilog/Multiplier19.v" \
   "./src/Multiplier_ref.v" \
   "./src/ip/xbip_multadd_0/xbip_multadd_0.xci" \
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/Multiplier_ref.v" ]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "Multiplier_ref" -objects $obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/src/ip/xbip_multadd_0/xbip_multadd_0.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Set 'sources_1' fileset file properties for local files
set file "xbip_multadd_0/xbip_multadd_0.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
